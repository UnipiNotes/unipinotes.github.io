...
Κυκλώνουμε το κελί στην τομή της **Pivot στήλης** με την **Pivot γραμμή**, στην περίπτωση μας το ο αριθμός $2$. 
...
Τώρα διμουργούμε τους πίνακες που ξέρουμε από τον Simplex.
...
1. $\textrm{Ζήτηση} > \textrm{Προσφορά}$
2. $\textrm{Ζήτηση} < \textrm{Προσφορά}$
3. $\textrm{Ζήτηση} = \textrm{Προσφορά}$ 
